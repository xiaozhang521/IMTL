...
@register_model_architecture("transformer", "transformer_mustc_en_de")
def transformer_mustc_de_en(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 1024)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
...
@register_model_architecture("transformer", "transformer_mustc_en_de_conv5")
def transformer_mustc_de_en_conv5(args):
    args.embed_conv_kernel = 5
    transformer_mustc_de_en(args)

@register_model_architecture("transformer", "transformer_mustc_en_de_conv5_rpr")
def transformer_mustc_de_en_conv5(args):
    args.embed_conv_kernel = 5
...
@register_model_architecture("transformer", "transformer_mustc_en_de_encoder_conv5")
def transformer_mustc_de_en_encoder_conv5(args):
    args.embed_conv_kernel = 5
    args.encoder_conv = getattr(args, "encoder_conv", 1)
    transformer_mustc_de_en(args)

@register_model_architecture("transformer", "transformer_mustc_en_de_encoder3_conv5")
def transformer_mustc_de_en_encoder3_conv5(args):
    args.embed_conv_kernel = 5
    args.encoder_conv = getattr(args, "encoder_conv", 3)
    transformer_mustc_de_en(args)

@register_model_architecture("transformer", "transformer_mustc_en_de_encoder3_conv3")
def transformer_mustc_de_en_encoder3_conv3(args):
    args.embed_conv_kernel = 3
    args.encoder_conv = getattr(args, "encoder_conv", 3)
    transformer_mustc_de_en(args)

@register_model_architecture("transformer", "transformer_mustc_en_de_conv_all")
def transformer_mustc_de_en_conv_all(args):
    args.embed_conv_kernel = 5
...
@register_model_architecture("transformer", "transformer_deep_enzh_768_conv")
