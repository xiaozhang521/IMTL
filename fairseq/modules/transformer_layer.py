...
from fairseq.modules import LayerNorm, MultiheadAttention, RelativeMultiheadAttention
    ...
    def build_self_attention(self, embed_dim, cfg):
        if cfg.max_relative_length == -1:
            ...
            return RelativeMultiheadAttention(
                ...
                dropout=cfg.attention_dropout,
                self_attention=True,
                max_relative_length=cfg.max_relative_length,
                k_only=cfg.k_only,
            )
