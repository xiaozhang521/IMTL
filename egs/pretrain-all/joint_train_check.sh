...
#exp_name=conformer_ctc_perturb_gtrans_pretrain_all_kd_embedding_finetune_st_lowerlr_noshare_inout_embedd
...
exp_name=st_joint_train_8gpu_ende_check
fine_tune=1
use_w2v_ctc=1
apply_mask=
...
#train_config=train_joint_hubert_check.yaml
train_config=train_joint_hubert_check.yaml
